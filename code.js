...
figma.ui.onmessage = (pluginMessage) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield figma.loadFontAsync({ family: "Inter", style: "Light" });
    yield figma.loadFontAsync({ family: "Inter", style: "Extra Light" });
    yield figma.loadFontAsync({ family: "Inter", style: "Black" });
    yield figma.loadFontAsync({ family: "Inter", style: "Medium" });
    yield figma.loadFontAsync({ family: "Dosis", style: "Medium" });
    const nodes = [];
    //FRAME
